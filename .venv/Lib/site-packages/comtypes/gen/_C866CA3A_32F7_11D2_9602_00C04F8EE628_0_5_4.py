...
__all__ = [
    ...
    'SPWORDPRONOUNCEABLE', 'SpeechTokenKeyAttributes',
    'SpeechDictationTopicSpelling', 'SPSVerb', 'SPSMF_UPS',
    'SpeechTokenKeyFiles', 'DISPID_SMSAMMHandle',
    'DISPID_SVSLastBookmark', 'SPSHT_NotOverriden',
    'SpTextSelectionInformation', 'DISPID_SRRPhraseInfo',
    'SP_VISEME_11', 'SPEI_RESERVED1', 'SSSPTRelativeToStart',
    'SLOStatic', 'ISpeechPhraseProperty', 'SVP_18',
    'DISPID_SpeechObjectTokenCategory',
    'ISpeechLexiconPronunciations', 'ISpeechLexiconPronunciation',
    'DISPID_SPILanguageId', 'SVP_7', 'DISPID_SRCPause',
    'eWORDTYPE_ADDED', 'SpeechTokenValueCLSID',
    'SPINTERFERENCE_LATENCY_WARNING', 'DISPID_SRGCommit',
    'SREStateChange', 'DISPID_SpeechPhraseRule',
    'DISPID_SVSInputWordPosition', 'DISPID_SRIsUISupported',
    'SpPhoneConverter', 'SPEI_RECO_OTHER_CONTEXT',
    'DISPID_SRCEventInterests', 'SpStream', 'SVP_21',
    'SpeechTokenShellFolder', 'DISPID_SOTGetStorageFileName',
    'DISPID_SVSpeakStream', 'SVEViseme', 'ISpeechAudio',
    'DISPID_SPRuleConfidence', 'SpeechTokenKeyUI',
    'SPFM_CREATE_ALWAYS', 'SPPS_Unknown', 'DISPID_SVSLastResult',
    'ISpRecognizer3', 'DISPID_SPEDisplayAttributes',
    'SPEI_SENTENCE_BOUNDARY', 'SPAS_RUN',
    'DISPID_SpeechPhraseBuilder', 'DISPID_SpeechPhraseProperties',
    'eLEXTYPE_MORPHOLOGY', 'DISPID_SLPPartOfSpeech',
    'ISpeechGrammarRules', 'SVF_None', 'SAFT11kHz8BitMono',
    'DISPIDSPTSI_ActiveOffset', 'ISpRecoContext',
    'DISPID_SpeechGrammarRuleStateTransitions', 'ISpNotifySink',
    'DISPID_SVEViseme', 'SPSHORTCUTPAIRLIST',
    'DISPID_SRCERecognitionForOtherContext', 'DISPID_SRStatus',
    'tagSPPROPERTYINFO', 'SpeechCategoryAppLexicons', 'SGRSTTEpsilon',
    'SAFT11kHz16BitMono', 'DISPID_SRRAlternates',
    'DISPID_SpeechMMSysAudio', 'SpCustomStream',
    'DISPID_SVEEnginePrivate', 'ISpStreamFormat', 'SPFILEMODE',
    'STSF_FlagCreate', 'SpInprocRecognizer', 'SVP_8',
    'DISPID_SRRSpeakAudio', 'DISPID_SPARecoResult',
    'DISPID_SRRAudioFormat', 'DISPID_SVStatus', 'DISPID_SPPs_NewEnum',
    'SPTEXTSELECTIONINFO', 'SVPAlert', 'SSFMOpenReadWrite',
    'SpeechPropertyLowConfidenceThreshold', 'DISPID_SBSWrite',
    'DISPID_SPRNumberOfElements', 'SAFT44kHz8BitMono',
    'SPWORDPRONUNCIATIONLIST', 'ISpeechRecoResultTimes',
    'SPEI_MAX_TTS', 'SVP_4', 'DISPID_SFSClose', 'ISpeechPhraseRule',
    'SPDKL_CurrentUser', 'DISPID_SVVoice', 'ISpeechLexiconWord',
    'DISPID_SABufferNotifySize', 'DISPID_SpeechObjectTokens',
    'DISPID_SGRsDynamic', 'SPAS_CLOSED', 'SAFTADPCM_22kHzStereo',
    'SGDSActiveWithAutoPause', 'DISPID_SPPName',
    'SAFT22kHz8BitStereo', 'ISpPhoneConverter', 'SPGS_EXCLUSIVE',
    'DISPID_SVEAudioLevel', 'DISPID_SMSGetData', 'SAFTADPCM_8kHzMono',
    'DISPID_SpeechRecognizer', 'SDA_Two_Trailing_Spaces',
    'SpPhoneticAlphabetConverter', 'DISPID_SpeechVoice',
    'DISPID_SPERequiredConfidence', 'eLEXTYPE_PRIVATE7',
    'DISPID_SVResume', 'DISPID_SPRulesCount',
    'DISPID_SpeechPhraseRules', 'SGSDisabled',
    'DISPID_SVESentenceBoundary', 'DISPID_SPIEnginePrivateData',
    'SPWORDPRONUNCIATION', 'SRTExtendableParse',
    'DISPID_SRCCmdMaxAlternates', 'SPPS_RESERVED3', 'DISPID_SVSpeak',
    'SPSHT_OTHER', 'SAFT16kHz16BitStereo', 'SAFTExtendedAudioFormat',
    'DISPID_SVSInputSentenceLength', 'tagSPTEXTSELECTIONINFO',
    'SAFT48kHz8BitMono', 'SpeechDiscardType', 'DISPID_SLPLangId',
    'SPGS_ENABLED', 'SAFT32kHz8BitStereo', 'SDKLCurrentConfig',
    'DISPID_SAVolume', 'SAFTCCITT_ALaw_8kHzMono', 'eLEXTYPE_PRIVATE8',
    'DISPID_SGRSTsCount', 'SRSInactiveWithPurge', 'SGRSTTWord',
    'SREAdaptation', 'DISPID_SVVolume', 'DISPID_SRCEBookmark',
    'SRAExport', 'DISPID_SRCRequestedUIType',
    'SpeechCategoryAudioOut', 'SLTUser', 'SVEAudioLevel', 'SPSLMA',
    'SDTDisplayText', 'DISPID_SPIGrammarId', 'DISPID_SPAsCount',
    'SpeechRecoProfileProperties', 'SP_VISEME_17',
    'SAFT24kHz8BitStereo', 'DISPID_SPAPhraseInfo', 'SLTApp',
    'DISPID_SLGetWords', 'SVP_9', 'DISPID_SRCEAdaptation',
    'SGRSTTTextBuffer', 'SpeechRuleState', 'SECFIgnoreCase',
    'DISPID_SRCRecognizer', 'DISPID_SRSClsidEngine', 'ISpRecoResult',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SVSFVoiceMask',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'DISPID_SVSVisemeId', 'SVP_10',
    'DISPID_SRCESoundStart', 'DISPID_SRCERecognition',
    'SpeechGrammarState', 'SPRECOGNIZERSTATUS', 'ISpStream',
    'SpVoice', 'SAFT24kHz16BitStereo', 'SpeechRuleAttributes',
    'DISPID_SPCLangId', 'ISpShortcut', 'DISPID_SRCEInterference',
    'DISPID_SpeechPhraseAlternate', 'ISpEventSource',
    'SPPS_RESERVED4', 'DISPID_SRCRetainedAudioFormat',
    'DISPID_SpeechLexiconProns', 'DISPID_SWFEFormatTag',
    'SRSEIsSpeaking', 'SITooQuiet', 'ISpeechVoice',
    'DISPID_SADefaultFormat', 'SDA_No_Trailing_Space',
    'DISPID_SpeechAudio', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'SpeechUserTraining', 'DISPID_SPCPhoneToId', 'SPEI_SR_PRIVATE',
    'SPEI_VOICE_CHANGE', 'SpShortcut',
    'DISPID_SPIAudioStreamPosition', 'SAFT48kHz16BitMono',
    'SP_VISEME_18', 'SPRST_INACTIVE_WITH_PURGE',
    'ISpeechPhraseAlternate', 'eLEXTYPE_PRIVATE15', 'DISPID_SPIRule',
    'SpMemoryStream', 'SAFT48kHz16BitStereo',
    'DISPID_SLAddPronunciationByPhoneIds', 'DISPID_SABIBufferSize',
    'DISPID_SRProfile', 'SPSModifier', 'DISPID_SLWs_NewEnum',
    'DISPID_SpeechVoiceEvent', 'SVP_14', 'SP_VISEME_14', 'SPBO_PAUSE',
    'SPWORDTYPE', 'DISPID_SpeechAudioFormat', 'DISPID_SAStatus',
    'eLEXTYPE_PRIVATE10', 'DISPID_SpeechGrammarRules',
    'STCInprocHandler', 'DISPID_SPPsItem', 'SpeechCategoryVoices',
    'DISPID_SMSALineId', 'DISPID_SPEs_NewEnum', 'DISPID_SVEBookmark',
    'STCAll', 'SRSActive', 'DISPID_SpeechRecoResultTimes',
    'SVEEndInputStream', 'SRSInactive', 'SPSMF_SRGS_SAPIPROPERTIES',
    'SPBO_TIME_UNITS', 'DISPID_SPEAudioSizeBytes',
    'DISPID_SRRSetTextFeedback', 'SPPS_Verb',
    'SAFTCCITT_ALaw_11kHzMono', 'SPWF_INPUT', 'SITooSlow',
    'DISPID_SRSCurrentStreamPosition', 'SPPS_RESERVED1', 'SASClosed',
    'SPINTERFERENCE_TOOQUIET', 'SPPARTOFSPEECH', 'SPBO_NONE',
    'SP_VISEME_7', 'DISPID_SDKCreateKey', 'SpSharedRecoContext',
    'SPFM_NUM_MODES', 'SPBINARYGRAMMAR', 'SpeechLexiconType',
    'ISpeechGrammarRuleStateTransitions',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SPSERIALIZEDPHRASE',
    'SPPHRASERULE', 'DISPID_SVPause',
    'DISPID_SVSLastStreamNumberQueued', 'SPEI_START_INPUT_STREAM',
    'eLEXTYPE_PRIVATE11', 'SPAUDIOSTATUS',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SAFTNoAssignedFormat',
    'DISPID_SRRRecoContext', 'SPEI_RESERVED3', 'SVP_11',
    'SPPS_RESERVED2', 'SPINTERFERENCE_NONE', 'STSF_CommonAppData',
    'DISPID_SOTSetId', 'DISPID_SLGetPronunciations',
    'SPEI_WORD_BOUNDARY', 'SpeechWordType', 'SRERecoOtherContext',
    'DISPID_SOTGetDescription', 'eLEXTYPE_RESERVED10',
    'SAFT24kHz16BitMono', 'DISPID_SPERetainedSizeBytes',
    'SpMMAudioEnum', 'DISPID_SPRuleEngineConfidence', 'SBOPause',
    'SVP_13', 'DISPIDSPRG', 'DISPID_SRGCmdSetRuleState',
    'SpeechTokenIdUserLexicon', 'SPFM_OPEN_READONLY', 'STSF_AppData',
    'SpStreamFormatConverter', 'ISpRecoCategory',
    'SpNotifyTranslator',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet', 'SPPS_Function',
    'SDTRule', 'SSFMCreate', 'ISpeechPhraseInfo',
    'SpeechRetainedAudioOptions', 'SP_VISEME_2',
    'DISPID_SRGSetTextSelection', 'DISPID_SAFSetWaveFormatEx',
    'SpeechPartOfSpeech', 'SpeechVisemeType',
    'DISPID_SRAudioInputStream', 'DISPID_SPRsItem', 'SPBO_AHEAD',
    'ISpNotifyTranslator', 'SGLexicalNoSpecialChars',
    'DISPID_SGRsItem', 'ISequentialStream', 'eLEXTYPE_PRIVATE9',
    'SAFT22kHz16BitStereo', 'DISPID_SpeechAudioStatus', 'SP_VISEME_9',
    'SPSERIALIZEDRESULT', 'eLEXTYPE_RESERVED9', 'ISpeechRecoResult2',
    'ISpeechTextSelectionInformation', 'DISPID_SPPConfidence',
    'ISpEventSink', 'SPPS_Interjection', 'SPLO_STATIC', 'SP_VISEME_3',
    'SPEI_RESERVED2', 'DISPID_SPIReplacements',
    'SpeechDataKeyLocation', 'DISPID_SVRate', 'SPRST_NUM_STATES',
    'SpeechAudioState', 'SVSFParseMask', 'DISPID_SGRs_NewEnum',
    'DISPID_SAFGuid', 'SAFT16kHz16BitMono', 'SAFTADPCM_11kHzStereo',
    'SRCS_Disabled', 'SAFT11kHz16BitStereo', '_SPAUDIOSTATE',
    'SGRSTTWildcard', 'SpeechAudioVolume', 'SPVPRIORITY',
    'DISPID_SOTCSetId', 'ISpObjectToken',
    'SSSPTRelativeToCurrentPosition', 'DISPID_SOTIsUISupported',
    'SREBookmark', 'SVSFParseAutodetect', 'SPLO_DYNAMIC',
    'SPAUDIOOPTIONS', 'DISPID_SpeechCustomStream', 'SPPS_Noun',
    'DISPID_SASCurrentSeekPosition', 'SVEAllEvents',
    'DISPID_SRGCmdLoadFromMemory', 'DISPID_SASetState',
    'DISPID_SpeechObjectToken', 'SpSharedRecognizer', 'SPRULESTATE',
    'DISPID_SRGetPropertyString', 'SpeechWordPronounceable',
    'DISPID_SVSInputSentencePosition', 'SAFTADPCM_11kHzMono',
    'SPCT_DICTATION', 'SGDSActive', 'SpeechCategoryPhoneConverters',
    'SPADAPTATIONRELEVANCE', 'eLEXTYPE_RESERVED8', 'ISpAudio',
    'SECFEmulateResult', 'Speech_StreamPos_RealTime',
    'DISPID_SGRsFindRule', 'DISPID_SVGetAudioOutputs',
    'DISPID_SVSCurrentStreamNumber', 'SPEI_SR_RETAINEDAUDIO',
    'DISPID_SpeechRecoResult2', 'DISPIDSPTSI_SelectionOffset',
    'SVESentenceBoundary', 'DISPID_SPCIdToPhone',
    'SpUnCompressedLexicon', 'DISPID_SRCERequestUI',
    'DISPID_SRGDictationLoad', 'SITooLoud',
    'DISPID_SRSNumberOfActiveRules', 'DISPID_SPEEngineConfidence',
    'SRAORetainAudio', 'SPEI_TTS_PRIVATE', 'SVP_2',
    'DISPID_SRGDictationUnload', 'DISPID_SBSSeek',
    'DISPID_SVEStreamStart', 'SpeechMicTraining',
    'DISPID_SPEAudioTimeOffset', 'DISPID_SRCEPhraseStart',
    'DISPID_SRGCmdLoadFromObject', 'DISPID_SPPChildren',
    'DISPID_SDKSetStringValue', 'SINone',
    'DISPID_SRSSupportedLanguages', 'DISPID_SGRsCount',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SPEI_TTS_AUDIO_LEVEL',
    'SPXRO_SML', 'DISPID_SLPsItem', 'DISPID_SRCEFalseRecognition',
    'SVEVoiceChange', 'DISPID_SpeechPhraseAlternates',
    'DISPID_SGRName', 'DISPID_SOTRemove', 'SPCATEGORYTYPE',
    'SPPHRASEPROPERTY', 'SPEI_SR_BOOKMARK', 'SGSEnabled',
    'IEnumSpObjectTokens', 'eLEXTYPE_PRIVATE1', 'DISPID_SPIGetText',
    'SPINTERFERENCE_TOOLOUD', 'SPINTERFERENCE', 'SAFTText',
    'DISPID_SASNonBlockingIO', 'ISpGrammarBuilder',
    'DISPID_SRGSetWordSequenceData', 'SAFT48kHz8BitStereo',
    'DISPID_SLAddPronunciation', 'DISPID_SOTs_NewEnum',
    'ISpeechRecoContext', 'SPRST_INACTIVE', 'SAFT12kHz16BitMono',
    'DISPID_SRSAudioStatus', 'SGRSTTDictation', 'eLEXTYPE_RESERVED4',
    'SPAR_Medium', 'WAVEFORMATEX', 'DISPID_SRCState',
    'DISPID_SpeechMemoryStream', 'DISPID_SPEPronunciation',
    'DISPID_SLGenerationId', 'DISPID_SRSCurrentStreamNumber',
    'SpeechPropertyResponseSpeed', 'SGRSTTRule', 'tagSTATSTG',
    'SpeechGrammarRuleStateTransitionType', 'DISPID_SDKEnumKeys',
    'DISPID_SPAsItem', 'SVEPrivate', 'SPPHRASEELEMENT', 'SVP_19',
    'SpLexicon', 'DISPID_SLRemovePronunciation', 'SPAUDIOSTATE',
    'DISPID_SRRTLength', 'ISpeechObjectTokenCategory',
    'SAFTGSM610_22kHzMono', 'DISPID_SVEStreamEnd',
    'DISPID_SVAlertBoundary', 'SDTPronunciation', 'SGDSInactive',
    'SASStop', 'SPEVENTENUM', 'DISPID_SVEPhoneme', 'SPSNotOverriden',
    'SREPrivate', 'DISPID_SLGetGenerationChange', 'ISpSerializeState',
    'SPRST_ACTIVE_ALWAYS', 'DISPID_SGRSTPropertyName',
    'SpeechVoiceSpeakFlags', 'SPSHORTCUTTYPE',
    'DISPID_SRGetRecognizers', 'ISpeechVoiceStatus',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SPVPRI_ALERT',
    'DISPID_SPEAudioStreamOffset', 'SpeechSpecialTransitionType',
    'SPSFunction', 'SpMMAudioOut', 'SPSEMANTICERRORINFO',
    'SDTLexicalForm', 'ISpeechResourceLoader', 'ISpeechDataKey',
    'DISPID_SRCCreateGrammar', 'SP_VISEME_1',
    'DISPID_SRSetPropertyNumber', 'SpInProcRecoContext',
    'DISPID_SRSetPropertyString', 'SAFT32kHz16BitStereo',
    'ISpRecognizer2', 'eLEXTYPE_PRIVATE4', 'SpeechBookmarkOptions',
    'SPCT_SLEEP', 'SPWF_SRENGINE', 'ISpeechPhraseInfoBuilder',
    'SPRECOSTATE', 'SPDATAKEYLOCATION', 'SPAR_High',
    'SpeechEmulationCompareFlags', 'ISpeechCustomStream', 'SBONone',
    'DISPID_SPPFirstElement', 'SAFT16kHz8BitMono', 'SpeechRunState',
    'SPEI_REQUEST_UI', 'ISpeechObjectToken', 'DISPID_SGRAttributes',
    'DISPID_SWFEBitsPerSample', 'SPEI_SR_AUDIO_LEVEL', 'SPPHRASE',
    'DISPID_SWFESamplesPerSec', 'SREInterference',
    'DISPID_SPRs_NewEnum', 'SPGRAMMARWORDTYPE',
    'DISPID_SGRSAddSpecialTransition', 'DISPID_SRRTOffsetFromStart',
    'SPRECOCONTEXTSTATUS', 'SECFNoSpecialChars',
    'DISPID_SGRSTransitions', 'eLEXTYPE_LETTERTOSOUND',
    'DISPID_SpeechPhraseReplacements', 'SPRS_ACTIVE',
    'DISPID_SPIStartTime', '_ISpeechRecoContextEvents',
    'SPEI_SOUND_END', 'SVEWordBoundary', 'eLEXTYPE_USER',
    'SVF_Emphasis', 'SpeechFormatType', 'DISPID_SGRSTsItem',
    'DISPID_SOTCGetDataKey', 'DISPID_SPIAudioSizeTime', 'SpMMAudioIn',
    'SP_VISEME_4', 'SpeechRecognizerState', 'DISPID_SDKEnumValues',
    'DISPID_SVAudioOutputStream', 'SPRS_INACTIVE',
    'SAFTGSM610_44kHzMono', 'DISPID_SOTCEnumerateTokens',
    'DISPID_SpeechRecoResult', 'SRSEDone',
    'SpeechGrammarTagUnlimitedDictation', 'SP_VISEME_10',
    'DISPID_SPRuleName', 'SpeechVoiceEvents', 'eLEXTYPE_PRIVATE13',
    'SAFT44kHz8BitStereo', 'SPEI_FALSE_RECOGNITION',
    'SAFTADPCM_44kHzStereo', '__MIDL_IWinTypes_0009', 'DISPIDSPTSI',
    'Speech_StreamPos_Asap', 'SRESoundStart', 'SPAR_Low',
    'DISPID_SPIGetDisplayAttributes', 'DISPID_SOTId',
    'DISPID_SRCEPropertyNumberChange', 'SPSHORTCUTPAIR',
    'DISPID_SPEDisplayText', 'SAFT16kHz8BitStereo',
    'ISpeechBaseStream', 'ISpeechFileStream', 'eLEXTYPE_PRIVATE16',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'ISpeechPhraseRules',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'DISPID_SGRAddResource',
    'DISPID_SPRulesItem', 'SREAudioLevel',
    'DISPID_SRGCmdLoadFromResource', 'DISPID_SpeechPhraseElement',
    'SECLowConfidence', 'SVF_Stressed', 'DISPID_SAFGetWaveFormatEx',
    'SVP_0', 'ISpeechPhraseReplacement', 'DISPID_SBSFormat',
    'DISPID_SPIEngineId', 'SpeechRecoEvents', 'DISPID_SBSRead',
    'DISPID_SpeechLexiconPronunciation', 'SVSFIsFilename', 'SASRun',
    'DISPIDSPTSI_ActiveLength', 'SVEBookmark', 'DISPID_SGRSTRule',
    'DISPID_SpeechPhraseProperty', 'DISPID_SVSLastBookmarkId',
    'DISPID_SPPsCount', 'DISPID_SPRuleId', 'ISpeechGrammarRule',
    'DISPID_SLPPhoneIds', 'SPSTREAMFORMATTYPE', 'SPEVENTSOURCEINFO',
    'DISPID_SRGCmdLoadFromFile', 'SRTStandard', 'SECHighConfidence',
    'SGDisplay', 'DISPID_SLRemovePronunciationByPhoneIds',
    'SPLOADOPTIONS', 'SPCONTEXTSTATE', 'DISPID_SAEventHandle',
    'DISPID_SRGId', 'SPVISEMES', 'DISPID_SVSyncronousSpeakTimeout',
    'DISPID_SpeechRecoContextEvents', 'DISPID_SLPs_NewEnum',
    'DISPID_SpeechPhraseInfo', 'DISPID_SPIElements',
    'DISPID_SDKOpenKey', 'SDTAudio', 'SPEI_INTERFERENCE',
    'DISPID_SGRSRule', 'ISpPhrase', 'DISPID_SRCEAudioLevel',
    'STSF_LocalAppData', 'SECFIgnoreWidth', 'SVSFPurgeBeforeSpeak',
    'SVP_1', 'DISPID_SGRSTText', 'DISPID_SOTGetAttribute',
    'ISpObjectWithToken',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet', 'ISpProperties',
    'SWTAdded', 'DISPID_SLWWord', 'SPWT_DISPLAY',
    'SPFM_OPEN_READWRITE', 'SAFT12kHz8BitMono', 'ISpPhraseAlt',
    'SpeechAllElements', 'DISPID_SpeechFileStream',
    'DISPID_SOTRemoveStorageFileName', 'SpAudioFormat',
    'SPPS_Noncontent', 'SAFTCCITT_uLaw_44kHzMono',
    'eWORDTYPE_DELETED', 'DISPID_SVAudioOutput', 'SVP_15',
    'DISPID_SPRules_NewEnum', 'SVSFIsNotXML', 'SPVPRI_NORMAL',
    'UINT_PTR', 'DISPID_SpeechBaseStream', 'SPAS_STOP',
    'SpObjectToken', 'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SRCAudioInInterferenceStatus', 'SRARoot', 'SREAllEvents',
    'DISPID_SpeechPhraseReplacement', 'DISPID_SOTCategory',
    'ISpeechGrammarRuleState', 'DISPID_SAFType', 'SVP_12',
    'SP_VISEME_6', 'ISpRecognizer', 'SVSFParseSsml',
    'DISPID_SpeechVoiceStatus', 'eLEXTYPE_PRIVATE18',
    'SAFT12kHz8BitStereo', 'SREHypothesis',
    'DISPID_SpeechLexiconWords', 'SRATopLevel',
    'DISPID_SVWaitUntilDone', 'SPAS_PAUSE', 'DISPID_SGRsCommit',
    'SDTProperty', 'SpeechLoadOption', 'SAFT8kHz8BitStereo',
    'SPVOICESTATUS', 'DISPID_SOTDataKey', 'DISPID_SRCEHypothesis',
    'DISPID_SGRAddState', 'SLODynamic', 'DISPID_SpeechPhoneConverter',
    'DISPID_SLWsItem', 'SPINTERFERENCE_TOOSLOW', 'SECFDefault',
    'SAFTCCITT_uLaw_8kHzMono', 'SAFTCCITT_uLaw_22kHzStereo',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'SPEI_VISEME',
    'DISPID_SVEVoiceChange', 'SSFMCreateForWrite',
    'ISpeechRecognizerStatus', 'DISPID_SPPBRestorePhraseFromMemory',
    'DISPID_SRRSaveToMemory', 'DISPID_SWFEChannels',
    ...
    'ISpeechPhraseAlternates', 'SPPS_SuppressWord', 'SPSUnknown',
    'SPCT_SUB_DICTATION', 'SPEI_END_SR_STREAM', 'SAFT11kHz8BitStereo',
    'SpeechAudioFormatType', 'DISPID_SRRTimes', 'eLEXTYPE_RESERVED6',
    'SpPhraseInfoBuilder', 'DISPID_SRRGetXMLResult',
    'SPINTERFERENCE_TOOFAST', 'SVP_3', 'DISPID_SPEsItem',
    'DISPID_SVSRunningState', 'SPDKL_CurrentConfig',
    'eLEXTYPE_PRIVATE12', 'SPAR_Unknown', 'SPXMLRESULTOPTIONS',
    'IInternetSecurityManager', 'STCInprocServer',
    'DISPID_SRCSetAdaptationData', 'DISPID_SMSSetData',
    'ISpRecoContext2', 'SpeechPropertyHighConfidenceThreshold',
    'SP_VISEME_16', 'DISPID_SWFEBlockAlign',
    'DISPID_SRCCreateResultFromMemory', 'SVSFlagsAsync',
    'DISPID_SRCBookmark', 'SpeechCategoryRecognizers',
    'ISpResourceManager', 'DISPID_SpeechRecognizerStatus',
    'DISPID_SABIEventBias', 'DISPID_SGRSTWeight',
    'DISPID_SPRuleParent', 'SPEI_HYPOTHESIS', 'SPEI_END_INPUT_STREAM',
    'SpeechGrammarTagDictation', 'DISPID_SPIProperties',
    'DISPID_SDKGetBinaryValue', 'SpeechVoicePriority',
    'DISPID_SRCEEnginePrivate', 'SpeechAudioFormatGUIDWave',
    'SPEI_MIN_TTS', 'DISPID_SPPParent', 'DISPID_SVGetVoices',
    'SPRULE', 'SSFMOpenForRead', 'ISpeechPhraseProperties',
    'SpeechStreamFileMode', 'eLEXTYPE_PRIVATE20', 'DISPID_SRGRules',
    'SAFT8kHz16BitMono', 'DISPID_SRRTTickCount',
    'DISPID_SPRuleNumberOfElements', 'ISpRecoGrammar2',
    'DISPID_SLWType', 'SPEI_PHRASE_START', 'SRAONone', 'SASPause',
    'SPSNoun', 'SPGRAMMARSTATE', 'DISPID_SGRSTNextState', 'SGLexical',
    'ISpStreamFormatConverter', 'SP_VISEME_13', 'SpeechAddRemoveWord',
    'SAFT44kHz16BitMono', 'DISPID_SWFEAvgBytesPerSec', 'SPWORDLIST',
    'SREPropertyStringChange', 'SPAUDIOBUFFERINFO', 'SREPhraseStart',
    'SpeechRecoContextState', 'SAFT8kHz16BitStereo',
    'ISpeechGrammarRuleStateTransition', 'DISPID_SRState',
    'ISpXMLRecoResult', 'SAFT44kHz16BitStereo', 'SP_VISEME_19',
    'SVSFPersistXML', 'DISPID_SPERetainedStreamOffset',
    'DISPID_SGRsCommitAndSave', 'DISPID_SGRSAddWordTransition',
    'ISpeechXMLRecoResult', 'SpWaveFormatEx', 'ISpeechPhraseElement',
    'SRTAutopause', 'STCLocalServer', 'DISPID_SRGRecoContext',
    'DISPID_SDKSetBinaryValue', 'ISpPhoneticAlphabetConverter',
    'SPCT_COMMAND', 'DISPID_SOTsItem', 'SRADefaultToActive',
    'DISPID_SRGetPropertyNumber', 'DISPID_SGRSTType',
    'ISpeechAudioStatus', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SAFTCCITT_uLaw_44kHzStereo',
    'SpNullPhoneConverter', 'SpeechDisplayAttributes',
    'DISPID_SGRClear', 'SDTReplacement', 'ISpeechRecoGrammar',
    'SpeechGrammarTagWildcard', 'DISPID_SRGIsPronounceable',
    'SRCS_Enabled', 'STCRemoteServer', 'DISPID_SOTCId',
    'DISPID_SVPriority', 'SpeechPropertyResourceUsage',
    'DISPID_SDKGetlongValue', 'Speech_Default_Weight', 'SP_VISEME_12',
    'SINoise', 'SPPS_NotOverriden', 'SPDKL_DefaultLocation',
    'DISPID_SLPsCount', 'DISPID_SVGetProfiles', 'SECNormalConfidence',
    'DISPID_SPRsCount', 'SDKLLocalMachine', 'SRAImport', 'SFTInput',
    'DISPID_SpeechDataKey', 'SAFTADPCM_8kHzStereo',
    'eLEXTYPE_PRIVATE2', 'SAFTCCITT_uLaw_11kHzMono',
    'DISPID_SGRSAddRuleTransition', 'Speech_Max_Word_Length',
    'DISPID_SVEWord', 'DISPID_SPEsCount', 'SRTReSent',
    'DISPID_SRRDiscardResultInfo', 'DISPID_SpeechLexiconWord',
    'SPEI_RECOGNITION', 'DISPID_SVSpeakCompleteEvent',
    'SpeechVisemeFeature', 'SSTTDictation',
    'SAFTTrueSpeech_8kHz1BitMono', 'DISPID_SGRSTPropertyId',
    'DISPID_SPRDisplayAttributes', 'SpeechRegistryUserRoot',
    'SRTEmulated', 'SPWT_PRONUNCIATION', 'DISPID_SRDisplayUI',
    'DISPID_SpeechRecoContext', 'SPBOOKMARKOPTIONS',
    'SpeechVoiceSkipTypeSentence', 'eLEXTYPE_PRIVATE17',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SVP_16',
    'eLEXTYPE_PRIVATE5', 'DISPID_SpeechGrammarRuleState', 'LONG_PTR',
    'DISPID_SRCEStartStream', 'ISpeechMemoryStream',
    'DISPID_SRCESoundEnd', 'SVPOver', 'eLEXTYPE_PRIVATE14',
    'DISPID_SRRecognizer', 'DISPID_SPEActualConfidence',
    'SAFTCCITT_uLaw_11kHzStereo', 'DISPID_SPPNumberOfElements',
    'SP_VISEME_20', 'DISPID_SRCreateRecoContext',
    'DISPID_SGRSTs_NewEnum', 'DISPID_SOTsCount',
    'SpeechStreamSeekPositionType', 'DISPID_SRRTStreamTime',
    'DISPID_SLWLangId', 'SITooFast', 'SVEStartInputStream',
    'ISpeechAudioFormat', 'SAFTGSM610_11kHzMono', 'SAFT8kHz8BitMono',
    'DISPID_SPELexicalForm', 'DISPID_SPRFirstElement',
    'eLEXTYPE_VENDORLEXICON', 'SAFTGSM610_8kHzMono',
    'DISPID_SOTCDefault', 'SDTAlternates', 'IInternetSecurityMgrSite',
    'SpeechVoiceCategoryTTSRate', 'SPXRO_Alternates_SML',
    'DISPID_SRCVoice', 'SpeechInterference', 'DISPID_SDKDeleteKey',
    'DISPID_SASFreeBufferSpace', '_RemotableHandle', 'SP_VISEME_5',
    'SPRECORESULTTIMES', 'ISpLexicon', 'DISPID_SpeechWaveFormatEx',
    'DISPID_SPIAudioSizeBytes', 'DISPID_SVSInputWordLength',
    'DISPID_SRCEPropertyStringChange', 'SREStreamStart',
    'SPSEMANTICFORMAT', 'SpeechRegistryLocalMachineRoot',
    'SPEI_RECO_STATE_CHANGE', 'SPEI_ADAPTATION',
    'SAFTCCITT_ALaw_44kHzStereo', 'SPWAVEFORMATTYPE',
    'DISPID_SPISaveToMemory', 'DISPID_SRRGetXMLErrorInfo',
    'SpFileStream', 'ISpeechMMSysAudio', 'SVSFDefault',
    'SSTTTextBuffer', 'SAFT22kHz16BitMono', 'SPPROPERTYINFO',
    'DISPID_SASState', 'SpeechPropertyComplexResponseSpeed',
    'DISPID_SGRsAdd', 'SGSExclusive', 'SVSFNLPSpeakPunc',
    'DISPID_SREmulateRecognition', 'SPEI_UNDEFINED', 'DISPID_SLPType',
    'DISPID_SPRuleChildren', 'SpeechCategoryAudioIn',
    'DISPID_SRCVoicePurgeEvent', 'ISpeechPhraseElements',
    'SpeechEngineProperties', 'SPSHT_EMAIL', 'ISpNotifySource',
    'SP_VISEME_0', 'SDA_Consume_Leading_Spaces', 'DISPID_SPPValue',
    'SPEI_MIN_SR', 'SVPNormal', 'SPEI_RESERVED5', 'SPEI_PHONEME',
    'DISPID_SLWPronunciations', 'eLEXTYPE_APP',
    'SAFT12kHz16BitStereo', 'SRERecognition', 'ISpeechLexicon',
    'DISPID_SFSOpen', 'SPEVENT', 'DISPID_SWFEExtraData',
    'DISPID_SpeechAudioBufferInfo', 'SVP_6', 'SSTTWildcard',
    'SpeechAudioProperties', 'eLEXTYPE_RESERVED7',
    'SpeechPropertyAdaptationOn', 'SWPUnknownWordPronounceable',
    'DISPID_SpeechPhraseElements', 'IEnumString',
    'SpeechPropertyNormalConfidenceThreshold', 'DISPID_SRRAudio',
    'SPWT_LEXICAL', 'DISPID_SVIsUISupported', 'SVP_20',
    'DISPID_SOTCreateInstance', 'DISPID_SVDisplayUI', 'SP_VISEME_21',
    'SPSHT_Unknown', 'DISPIDSPTSI_SelectionLength', 'SP_VISEME_8',
    'SPEI_RESERVED6', 'eLEXTYPE_PRIVATE6', 'SAFTCCITT_uLaw_22kHzMono',
    'ISpPhoneticAlphabetSelection', 'SpeechTokenContext',
    'SGDSActiveUserDelimited', 'SPINTERFERENCE_NOSIGNAL',
    'SRADynamic', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'ISpObjectTokenCategory', 'SPSSuppressWord',
    'DISPID_SRCERecognizerStateChange', 'SFTSREngine', 'SWTDeleted',
    'DISPID_SPRText', 'ISpeechWaveFormatEx', 'SPRST_ACTIVE',
    'SDKLDefaultLocation', 'ISpeechLexiconWords',
    'ISpeechRecoResultDispatch', 'SPWORD', 'SAFT24kHz8BitMono',
    'DISPID_SABufferInfo', 'ISpDataKey', 'SVP_17',
    'DISPID_SpeechGrammarRule', 'DISPID_SPEAudioSizeTime',
    'SPEI_PROPERTY_NUM_CHANGE', 'ISpeechRecoResult',
    'DISPID_SPRuleFirstElement', 'DISPID_SLWsCount',
    'SAFT32kHz16BitMono', 'SPCT_SUB_COMMAND', 'SPPHRASEREPLACEMENT',
    'SPRS_ACTIVE_USER_DELIMITED', 'SAFTCCITT_uLaw_8kHzStereo',
    'ISpVoice', 'ISpeechRecognizer', 'SSSPTRelativeToEnd',
    'DISPID_SGRSTPropertyValue', 'DISPID_SGRInitialState',
    'SAFTADPCM_44kHzMono', 'DISPID_SRAudioInput',
    'DISPID_SPPEngineConfidence', 'DISPID_SPAs_NewEnum',
    'SpeechEngineConfidence', 'SpeechCategoryRecoProfiles',
    'ISpRecoGrammar', 'SRAInterpreter', 'DISPID_SRGDictationSetState',
    'SECFIgnoreKanaType', 'DISPID_SRGetFormat', 'DISPID_SGRId',
    'SRERequestUI', 'DISPID_SpeechXMLRecoResult', 'SpResourceManager',
    'ISpeechObjectTokens', 'eLEXTYPE_USER_SHORTCUT',
    'eLEXTYPE_PRIVATE19', 'SWPUnknownWordUnpronounceable',
    'SPVPRI_OVER', 'SAFT32kHz8BitMono', 'DISPID_SCSBaseStream',
    'eLEXTYPE_PRIVATE3', 'DISPID_SPANumberOfElementsInResult',
    'DISPID_SVSkip', 'SPFM_CREATE', 'SPINTERFERENCE_NOISE',
    'ISpMMSysAudio', 'SDA_One_Trailing_Space', 'SVEPhoneme',
    'SPAO_NONE', 'IStream', 'DISPID_SRCEEndStream', 'SRTSMLTimeout',
    'SPAO_RETAIN_AUDIO', 'SRSActiveAlways',
    'DISPID_SRGCmdSetRuleIdState', 'SAFTNonStandardFormat',
    'DISPID_SOTDisplayUI', 'SP_VISEME_15',
    'DISPID_SASCurrentDevicePosition', 'SAFTCCITT_ALaw_11kHzStereo',
    'SPEI_START_SR_STREAM', 'SAFTCCITT_ALaw_22kHzMono',
    'ISpeechAudioBufferInfo', 'SpeechRecognitionType',
    'DISPID_SDKSetLongValue', 'SPPS_LMA', 'SPCS_ENABLED',
    'SREFalseRecognition', 'DISPID_SMSADeviceId',
    'DISPID_SDKGetStringValue', 'SpeechAudioFormatGUIDText', 'SVP_5',
    'SVSFIsXML', 'SpeechGrammarWordType',
    'DISPID_SOTMatchesAttributes', 'SPDKL_LocalMachine',
    'DISPID_SDKDeleteValue', 'SPCS_DISABLED',
    'ISpeechPhraseReplacements', 'DISPID_SRGState', 'DISPID_SRGReset',
    'SREStreamEnd', 'SPPS_Modifier', 'SINoSignal', 'DISPID_SRCResume',
    'SAFTADPCM_22kHzMono', 'DISPID_SVSPhonemeId', 'SRESoundEnd',
    'SDTAll', 'DISPID_SRIsShared', 'DISPID_SVGetAudioInputs',
    '_ISpeechVoiceEvents', 'DISPID_SPACommit',
    'SPSMF_SAPI_PROPERTIES', 'SpCompressedLexicon',
    'SPEI_TTS_BOOKMARK', 'SAFTCCITT_ALaw_44kHzMono',
    'SVSFUnusedFlags', 'SPEI_SOUND_START', 'SpObjectTokenCategory',
    'SVSFNLPMask', 'SDKLCurrentUser', 'DISPID_SpeechLexicon',
    'SPGS_DISABLED', 'SAFTDefault', 'SREPropertyNumChange',
    'DISPID_SPPId', 'ISpeechPhoneConverter',
    'SAFTCCITT_ALaw_22kHzStereo', 'DISPID_SVEventInterests',
    'SVSFParseSapi', 'SPSInterjection',
    'DISPID_SPAStartElementInResult', 'DISPID_SRCRetainedAudio',
    'SAFTCCITT_ALaw_8kHzStereo', 'SAFT22kHz8BitMono', 'SPEI_MAX_SR'
]

_check_version('1.2.0', 1635983895.676111)
